...
Try {
	...
	[string]$appName = 'Technical Communication Suite'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Copy exercise files
		$COMExerciseFiles = "${envSystemDrive}\COM Exercise Files"
		...
		$AccessRule = New-Object System.Security.AccessControl.FileSystemAccessRule("Users","Modify","ContainerInherit, ObjectInherit","InheritOnly","Allow")
		$ACL.SetAccessRule($AccessRule)
		Set-Acl "$COMExerciseFiles" $ACL

		## Create desktop shortcut to exercise files folder
		New-Shortcut -Path "$envCommonDesktop\COM Exercise Files.lnk" -TargetPath "$envSystemDrive\COM Exercise Files"
